...
const chats = [
	...
	},
	{
		...
		lastMessage: {
			...
			date: Date.now(),
			textMessage:
				"hello retardSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS",
		},
...
export default class Store {
	...
	async setUser(user: IUser) {
		const friendsArr: IUser[] = (
			await UserService.getFriendListFromId(user._id)
		).data;
		...
		const chats: IChat[] = (await UserService.getAllUsersChats(user._id))
			.data;
